...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Handle Share Your Experience form submission
    experienceForm?.addEventListener('submit', function (e) {
        ...
        // Simulate submission (replace this with actual API request if needed)
        console.log('Experience Submitted:', { name, email, message });
        experienceForm.reset(); // Reset the form fields

        // Show success feedback
        const feedbackDiv = document.getElementById('feedback');
        feedbackDiv.textContent = 'Thank you for sharing your experience!';
